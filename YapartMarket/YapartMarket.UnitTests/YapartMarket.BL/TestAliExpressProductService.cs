...
namespace YapartMarket.UnitTests.YapartMarket.BL
{
    public class TestAliExpressProductService
    {
        ...
        private readonly ILogger<AliExpressProductService> _mockLogger;
        public TestAliExpressProductService()
        {
            ...
            var mock = new Mock<ILogger<AliExpressProductService>>();
            ILogger<AliExpressProductService> logger = mock.Object;
            _mockLogger = Mock.Of<ILogger<AliExpressProductService>>();
        ...
        public void TestAliExpressProductService_ProductStringToDTO_NotNUll()
        {
            ...
            var aliExpressProductService = new AliExpressProductService(_aliExpressOption, _configuration, _mockLogger);
            //Arrange
