...
const addErrorAlert = (message: {} | null | undefined, key?: string | undefined, data?: { entityName?: null; fieldName?: any; } | undefined) => {
 toast.error(message);
};
export default () => (next: (arg0: any) => Promise<any>) => (action: any) => {
